        ...
        return [
            [
                ...
                'thumbs' => [
                    ...
                    'catalog_product_main' => [/*'width' => 750, 'height' => 500], //*/'processor' => [new WaterMarker(750, 500, '@frontend/web/image/logo.png'), 'process']],
                    'catalog_product_additional' => ['width' => 66, 'height' => 66],
                    'catalog_origin' => [/*'width' => 1024, 'height' => 768], //*/'processor' => [new WaterMarker(1024, 768, '@frontend/web/image/logo.png'), 'process']],
                ],
            ],
        ];
    }
