...
<div class="cabinet-index">
    ...
    <div class="buttons clearfix">
        <div class="pull-left"><a href="<?= Url::to('/shop/catalog/index') ?>" class="btn btn-default">В магазин</a></div>
        <?php if ($cart->getItems()): ?>
            <div class="pull-right"><a href="<?= Url::to('/shop/checkout/index') ?>" class="btn btn-primary">Оплатить</a></div>
        <?php endif; ?>
    </div>
</div>
